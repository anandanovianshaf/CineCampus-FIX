            ...
            <div class="w-full h-[550px] flex flex-col relative bg-black">
                <div class="flex flex-row items-center w-full h-full">
                    ...
                    <div class="w-10/12 flex flex-col ml-28 z-10 p-4">
                        ...
                        <a href="<?php echo $movie['trailer_link']; ?>" target="_blank" class="w-fit bg-[#FFC65D] text-white px-4 py-2 mt-14 rounded-full text-sm font-inter hover:drop-shadow-lg duration-200">
                            PLAY TRAILER
                        </a>
